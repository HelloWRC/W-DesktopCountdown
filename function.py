...
class ProfileMgr:
    ...
    def spawn_countdown_win(self, name: str):
        self.config_mgr[name] = ConfigFileMgr(profile_prefix + name, CountdownWin.countdown_config_default)
        self.countdowns_win[name] = CountdownWin(self.app, qss_prefix + name, self.config_mgr[name])
